                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img img class="img-responsive rounded-circle" src="<?php echo empty($result['avatar_path'])? "uploads/blank.png":$result['avatar_path'];?>"/><span class="name_user"><?php echo $_SESSION['username']?></span></a>
